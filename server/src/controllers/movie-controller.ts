import {
  RestController,
  RestControllerAsyncHandler as Handler,
...
// ----------------------------------------------
// handlers
const trending: Handler = async (_req, _res, api) => {
...
const topRate: Handler = async (_req, _res, api) => {
...
const discover: Handler = async (_req, _res, api) => {
...
const trailerMovie: Handler = async (_req, _res, api) => {
...
const searchMovie: Handler = async (_req, _res, api) => {
...
// ----------------------------------------------
// controller
export const movieController = new RestController().addAsyncHandlerFromObject({
  trending,
  searchMovie,
  trailerMovie,
  discover,
